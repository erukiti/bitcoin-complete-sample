...
describe('sha256', () => {
  it('', () => {
    ...
    expect(sha256('hoge')).toEqual(
      'ecb666d778725ec97307044d642bf4d160aabb76f56c0069c71ea25b1e926825'
    )
    expect(sha256('The quick brown fox jumps over the lazy dog.')).toEqual(
      'ef537f25c895bfa782526529a9b63d97aa631564d5d789c2b765448c8635fb6c'
    )
    expect(
      sha256('01234567890123456789012345678901234567890123456789012345')
    ).toEqual(
