...
it('', () => {
  const txIns = [
    {
      hash:
        'cf9c1fa2b6ec299a8d86d50bb431cbf839d587d520e7b1ae2824dd45988c0451',
      index: 0,
      keypair: Keypair.fromWIF('cRP4uLLamkLpZK3bP7BNiztYn3DRkmXnkesR42AFfTeHhaF1QPTg'),
      value: '00f2052a01000000',
      script: '21023d64a1b2c6d7762b68437cd80b07182b98b55cee0ff26b8af859c8fb472cc1e7ac'
    }
  ]
  const txOuts = [
    {
